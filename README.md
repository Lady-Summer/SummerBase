# SummerBase: The Next-Generation of Graph Analytic Platform
## Introduction
...
I think It should be handled by a system like Job Scheduler. Importantly, user-interfaces should make a clear definition that such a task is OLAP or OLTP. **It's not included in our initial work and will be considered in the future**. 
